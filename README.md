...
- Core Python fundamentals (loops, functions, data structures, error handling)
- File I/O and working with JSON
- Object-oriented programming
- Standard library modules (`random`, `time`, `csv`, `os`, and more)
...
| 20 | Weather Data Analyzer | CSV parsing, data analysis |
